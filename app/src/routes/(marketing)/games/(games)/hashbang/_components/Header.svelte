<script lang="ts">
  // @ts-ignore
  import IconHowTo from "~icons/fa6-solid/lightbulb"
  // @ts-ignore
  import IconStatistics from "~icons/fa6-solid/chart-pie"
  // @ts-ignore
  ...
  let base_path: string = "/games/hashbang"
...
<div class="flex justify-between items-center m-1">
  ...
  <div class="flex">
    <div class="flex {howToClass}">
      <a href="/games/hashbang/how_to">
        <button
          class="btn btn-ghost btn-square text-lg rounded-b-none"
          aria-label="hashbang_how_to"
        >
          <IconHowTo />
        </button>
      </a>
    ...
    <div class="flex {statisticsClass}">
      <a href="/games/hashbang/statistics">
        <button
          class="btn btn-ghost btn-square text-lg rounded-b-none"
          aria-label="hashbang_statistics"
        >
          <IconStatistics />
        </button>
      </a>
    ...
    <div class="flex {extrasClass}">
      <a href="/games/hashbang/extras" aria-label="hashbang_extras">
        <button
          class="btn btn-ghost btn-square text-lg rounded-b-none"
          aria-label="hashbang_extras"
        >
          <IconExtras />
        </button>
      </a>
