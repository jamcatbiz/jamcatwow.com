...
export const hasGameOverShown = new LocalStorage(
  "jamcat_ladders_hasGameOverShown",
  false,
  false,
  (str: string) => {
    return str === "true"
...
export const statGamesPlayed = new LocalStorage(
  "jamcat_ladders_statGamesPlayed",
  0,
  false,
  (str: string) => {
    return Number(str)
...
export const statNumbersFound = new LocalStorage(
  "jamcat_ladders_statWordsFound",
  0,
  false,
  (str: string) => {
    return Number(str)
